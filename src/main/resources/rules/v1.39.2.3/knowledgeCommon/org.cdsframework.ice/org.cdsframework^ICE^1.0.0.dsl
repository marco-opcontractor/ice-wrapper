...
[consequence][][Ii]nclude the [Rr]eason for [Ss]hot {refer_oTargetDose} [Ii]nvalid due to "Same Season RSV mAB"={refer_oTargetDose}.addInvalidReason("EVALUATION_REASON_CONCEPT.SAME_SEASON_RSV"); {refer_oTargetDose}.setRuleName(drools.getRule().getName());
